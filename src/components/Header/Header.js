...
import './Header.css';
import pic from './flipkart.png';

const Header = () => {
    return (
        <div className="body">
           <img className="pic" src={pic}/>
           <input type="text" className="mt2" placeholder="Search for Products, Brands and More"/>
           <div className="dropdown">
                <button className="dropbtn b mh2 f6 mt2">Login</button>
                <div className="dropdown-content li1">
                    <a href="#">Sign up</a>
                    <a href="#">
           ...
           <h3>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-cart-fill white" viewBox="0 0 16 16">
